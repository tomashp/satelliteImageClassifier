...
import pickle
import os
# RUN SCRIPT FROM WHERE YOU WANT TO SAVE FILES
# CHOOSE the option
...
# with open(dataset_folder_path + processName + "SamplesList.plk", mode='rb') as file:
...
evalTrainings.test_model( save_model_path, allDataPreProcessedPath )
